...
import com.example.hotelapp.databinding.FragmentReservationsBinding
...
class ReservationsFragment : Fragment(), ReservationsAdapter.OnReserveClickListener {
    ...
    override fun onCreateView(
        ...
        requireActivity().title = "Reservaciones"
    ...
    override fun onReserveClick(position: Int) {
        ...
        builder.setPositiveButton("Si") { dialog, _ ->
            ...
            dialog.dismiss()
            Toast.makeText(requireContext(), "Reservación cancelada", Toast.LENGTH_SHORT).show()
        }
