...
import com.example.hotelapp.databinding.FragmentProfileBinding
...
class ProfileFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        binding.settingsButton.setOnClickListener {
            Toast.makeText(requireContext(), "Se implementará pronto esta función.", Toast.LENGTH_SHORT).show()
        }
